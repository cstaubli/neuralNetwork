...
for lr in range(1, 9, 1):
    ...
    for e in range(EPOCHS):
        ...
        for record in data_list_train:
            ...
            # rotate by 10°
            inputs_plus10 = scipy.ndimage.interpolation.rotate(input=inputs.reshape(28, 28), angle=10, cval=0.01, reshape=False)
            # rotate by -10°
            inputs_minus10 = scipy.ndimage.interpolation.rotate(input=inputs.reshape(28, 28), angle=-10, cval=0.01, reshape=False)
